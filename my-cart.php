				...
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<a href="index.php" class="btn btn-upper btn-info outer-left-xs">Continue Shopping</a>
								<input type="submit" name="submit" value="Update shopping cart" class="btn btn-upper btn-info pull-right outer-right-xs">
							</span>
...
<div class="form-group">
 ...
 <div class="form-group">
					  ...
					  <button type="submit" name="update" class="btn-upper btn btn-info checkout-page-button">Update</button>
...
<div class="form-group">
 ...
 <div class="form-group">
					  ...
					  <button type="submit" name="shipupdate" class="btn-upper btn btn-info checkout-page-button">Update</button>
					<?php } ?>
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-info">PROCCED TO CHEKOUT</button>
