...
{
    ?>
                <a href="sub-category.php?scid=<?php echo $row['id'];?>" class="dropdown-toggle"><i class="icon fa fa-plus fa-fw"></i>
					...
					<ul class="list-unstyled">
						<li class="add-cart-button btn-group">
								...
								<?php if($row['productAvailability']=='In Stock'){?>
										<button class="btn btn-info icon" data-toggle="dropdown" type="button">
