...
<div class="panel panel-default checkout-step-01">
	...
	<div id="collapseOne" class="panel-collapse collapse in">
	    ...
	    <!-- <input type="radio" name="paymethod" value="intenet banking" checked="checked"> <a href="payment.php"> Internet Banking </a>		 -->
	     <!-- <input type="radio" name="paymethod" value="Debit / Credit card"> Debit / Credit card <br /><br /> -->
	     <input type="submit" value="submit" name="submit" class="btn btn-info">
<br><br>
	     <a href="payment.php" class="btn btn-info"> online payment </a>
		</form>	
